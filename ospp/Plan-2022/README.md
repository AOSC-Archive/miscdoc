...
每个项目的导师应当参考《项目管理指南》和《导师工作手册》撰写前期文档。在文档工作上需要帮助时，请联系 Neruthes。
...
| 项目                       | 导师         | PRD | SDS | 技术选型 |
| -------------------------- | ------------ | --- | --- | -------- |
| 学生自选项目的本地化       | Mingcong Bai | ?   | N/A | N/A      |
| 全志 D1 U-Boot 实现        | Icenowy      | ?   | ?   | N/A      |
| LoongArch 移植（BuildKit） | Saki         | ?   | ?   | N/A      |
| 新版 Packages 站           | liushuyu     | ?   | ?   | ?        |
| AOSC Wiki 文档优化         | OriginCode   | ?   | N/A | N/A      |
